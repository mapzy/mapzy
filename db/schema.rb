...
ActiveRecord::Schema.define(version: 2022_04_23_104215) do
  ...
  create_table "locations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "geocoding_status", default: 0, null: false
    t.index ["geocoding_status"], name: "index_locations_on_geocoding_status"
